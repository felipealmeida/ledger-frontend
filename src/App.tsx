...
import BudgetVisualization from './components/BudgetVisualization'; // Add this import
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-6">
                    ...
                    {/* Action Buttons Row */}
                    {((data && !selectedAccount && !transactionData) || budgetData) && (
                ...
                {data && !selectedAccount && !transactionData && !showBudget && showExpenseDiff && (
